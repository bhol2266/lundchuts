...
export async function getStaticPaths() {
    ...
    return {
        ...
        paths: [
            { params: { homepageVideos: 'trending', page: '2' } },
        ],
...
export async function getStaticProps(context) {
    ...
    if (homepageVideos === 'trending') {
        await scrape(`https://spankbang.com/trending_videos/${page}`)

    }
    else if (homepageVideos === 'upcoming') {
        await scrape(`https://spankbang.com/upcoming/${page}`)

    }
    else if (homepageVideos === 'popular') {
        await scrape(`https://spankbang.com/most_popular/${page}`)

    }
    else {
        await scrape(`https://spankbang.com/new_videos/${page}`)
